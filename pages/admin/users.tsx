...
<div className='grid md:grid-cols-4 md:gap-5'>
            <div className='text-indigo600'>
                <ul>
                    <li>
                        <Link className='text-indigo bg-white bg-opacity-80 p-1 rounded-md' href="/admin/dashboard">
                            Painel Principal
                        </Link>
                    </li>
                    <li>
                    ...
                    <li>
                        <Link className='text-indigo bg-white bg-opacity-80 p-1 rounded-md' href='/admin/products'>
                        Vendas</Link>
                    </li>
                    <li>
                        <Link className='text-indigo' href='/admin/users'>
                            <span className='font-bold text-xl bg-white bg-opacity-80 p-1 rounded-md'>Usuários</span></Link>
                    </li>
